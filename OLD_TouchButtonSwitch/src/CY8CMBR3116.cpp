...
bool CY8CMBR3116::uploadConfiguration(uint8_t _setupConfig)
{
  ...
  // following configuration code was created by EZClick for the Cypres Cy8CMBR33116
  // TODO: Detailed infos what is set up
  ...
  // setup configuration for hardware rev 2.1
  // TODO: @@@
  else
  {
    configurationData = {
